...
from ode.vibration import forced_vibrations, damping, runga_kutta_vibrations, scipy_ode_vibrations
...
class ODE(unittest.TestCase):
    def test_ode(self):
        ...
        b = 2
        n = 10
        x_val, y_val_euler = euler(a, b, n, f, (0, 0.5))
        _, y_val_rk = runga_kutta_4(a, b, n, f, (0, 0.5))
